...
public class CameraView : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        EventService.Instance.OnPlayerDeath.AddListener(Shake);
        EventService.Instance.OnRatRush.AddListener(Shake);
        EventService.Instance.OnSkullShowered.AddListener(Shake);
    }

    private void OnDisable()
    {
        EventService.Instance.OnLightsOffByGhostEvent.RemoveListener(Shake);
        EventService.Instance.OnPlayerDeath.RemoveListener(Shake);
        EventService.Instance.OnRatRush.RemoveListener(Shake);
        EventService.Instance.OnSkullShowered.RemoveListener(Shake);
    }
